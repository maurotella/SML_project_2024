...
\cite{iandola2016squeezenetalexnetlevelaccuracy50x} suggests; as proof of this, SqueezeNet v1.1, that
was used, has \num{722378} params, $\sim$51.63 times less than AlexNet models described in section
\ref{sec:AlexNet}. 
...
\begin{itemize}
    \item A squeeze convolution layer: it uses $s_{1\!\times\!1}$ filters $1\!\times\!1$ to squeeze all
        the input channels into $s_{1\!\times\!1}$ single feature maps;
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{tikz/fire.tex}}
    \captionsetup{width=0.94\linewidth}
    \caption{A graphical representation of Squeeze and excitation; in this case a reduction ratio of $r=2$ 
    is used with 8-channel feature maps.}
\end{figure}
