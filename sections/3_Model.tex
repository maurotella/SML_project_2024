...
\begin{enumerate}
    \item Replace most of $3\!\times\!3$ filters with $1\!\times\!1$ filter: in this way they reduce the numbers of 
    $3\!\times\!3$ filters by replacing them with $1\!\times\!1$ filters that have 9 times fewer parameters;
...
\begin{itemize}
    \item A squeeze convolution layer: it uses $s_{1\!\times\!1}$ filters $1\!\times\!1$ to squeeze all
        the input channels into $s_{1\!\times\!1}$ single channel feature maps (Figure \ref{fig:squeeze});
    \item An expand layer: formed by $e_{1\!\times\!1}$ filters $1\!\times\!1$ and $e_{3\!\times\!3}$ 
        ...
        $s_{1\!\times\!1}$ to be less than $e_{1\!\times\!1}+e_{3\!\times\!3}$.
\end{itemize}
